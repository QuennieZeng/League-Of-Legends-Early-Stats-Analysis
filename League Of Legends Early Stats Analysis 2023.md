...
<iframe src="03-topic.html" width=800 height=600 frameBorder=0></iframe>
...
Our observed statistic was: _____________
Our p-value: ___________________________________________

Here is the empirical distribution of the test statistic: 
<iframe src="03-topic.html" width=800 height=600 frameBorder=0></iframe>

For our hypothesis testing, we did ______________ simulations and were able to see that _______there is a correltion in distrubution?_________

Conclusion: __________We fail to reject the null hypothesis. Meaning we believe that the distributions are the same._________________

Since we failed to reject the null hypothesis this means there is little evidence that the distribution of early game statistics in games where the team won is different from the distribution of statistics where the team won. 
